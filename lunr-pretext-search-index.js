...
},
{
  ...
  "number": "2.1",
  "title": "",
  "body": "   Row reduce matrices representing systems of linear equations using the Python library Sympy.    Use the pivots of a reduced augmented matrix to determine if a system has no solution, a unique solution, or infinitely many solutions    Graph solutions to systems of linear equations of two or three variables.    Graph solutions to vector equations in and .    "
},
{
  "id": "augmatrix",
  "level": "2",
...
{
  "id": "section-systems-8-3",
  "level": "2",
  "url": "section-systems.html#section-systems-8-3",
  "type": "Example",
  "number": "2.11",
  "title": "",
...
},
{
  ...
  "number": "1",
  "title": "",
  "body": "The system has a unique solution. Use Python code to find the solution. Graph the system of equations and the solution using Matplot3D. Label your axes. Note: part of the challenge is making sure you have a good viewing window and perspective so the graph helps illuminate the solution.  "
},
{
