...
},
{
  ...
  "number": "2.11",
  "title": "",
  "body": "Perhaps a better fix is to use exact values. That is, use Sympy's rational numbers instead of decimals since decimals use floating point representation. Fix the row reduction round-off error for the original system in Example by using Sympy's Rational() function instead. "
},
{
  "id": "exercise-49",
  "level": "2",
