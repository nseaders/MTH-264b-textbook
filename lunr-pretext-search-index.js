...
},
{
  ...
  "body": " Diagonalizing A  Consider the matrix transformation given by As we saw in , has an eigen-basis for . Moreover, we found a transformation from the standard basis to those eigenvectors is given by If we want to instead scale an eigenbasis we can first transform our eigen-basis vectors to the standard basis vectors, use a dilation matrix then transform back to our eigenbasis as follows.     Step 1: Find the matrix transformation from the standard basis to the eigenbasis.     Step 2: Use the inverse to transform from the eigenbasis to the standard basis.    Step 3: Find the corresponding dilation matrix  Since we mapped the eigenvector with eigenvalue of 1 to and the eigenvector with eigenvalue of 4 to , we want to scale by the eigenvalue of 1 and by the eigenvalue of 4.      "
},
{
  "id": "exercise-92",
  "level": "2",
